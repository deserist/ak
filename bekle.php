...
<html lang="tr">
  ...
  <body data-lang="tr_TR.UTF-8" style="visibility: visible; overflow: auto;">
    <div id="page" style="min-height: 38em;">
      ...
      <body>
        <div class="card-box" style="text-align: center;">
          <div class="preloader">
            ...
            <p class="pc" style="font-size: 15px; color: #444444; ">İşleminiz devam ediyor, lütfen beklemeye devam ediniz...</p>
          </div>
          <br>
          <p class="pc" style="font-size: 15px; color: black;">Şu anda kullandığınız hizmette yaşanan talep yoğunluğu nedeni ile işleminiz sıraya alınmıştır. İşlem sonucunuz birazdan otomatik olarak görüntülenecektir...</p>
          <div class="preloader2">
 <img src="https://media2.giphy.com/media/3oEjI6SIIHBdRxXI40/200w.gif?cid=6c09b952b8lvwrl6erxn19mxh3y3civpifk4du2d0sr1ujv5&ep=v1_gifs_search&rid=200w.gif&ct=g">
            <br>
            <p class="pc" style="font-size: 15px; padding: 11px; color: #818181;">Bekleme süreniz hizmet veren kurumun işlem kapasitesine göre değişebilir. İşleminiz tamamlandığında, otomatik olarak bir sonraki aşamaya geçiceksiniz.</p>
            <br>
          </div>
        </div>
        <br>
...
<script type="text/javascript">
  ...
  <script src="./assets/js/cactus.js" type="text/javascript"></script>
</html>